...
from .deprecate import set_new_attribute_deprecated
...
class Request:
        ...
        if not proxy_url:
            ...
            if proxy_url.startswith('socks'):
                try:
                    ...
                    from ..vendor.ptb_urllib3.urllib3.contrib.socks import SOCKSProxyManager
    ...
    def _request_wrapper(self, *args: object, **kwargs: Any) -> bytes:
        ...
        except dealmanagement.integration_utils.vendors.telegram.vendor.ptb_urllib3.urllib3.exceptions.TimeoutError as error:
            raise TimedOut() from error
        except dealmanagement.integration_utils.vendors.telegram.vendor.ptb_urllib3.urllib3.exceptions.HTTPError as error:
