...
from dealmanagement.integration_utils.its_utils.app_get_params import get_params_from_sources
from dealmanagement.integration_utils.bitrix_robots.errors import VerificationError, DelayProcess
from dealmanagement.integration_utils.bitrix_robots.helpers import get_php_style_list
...
class BaseBitrixRobot(models.Model):
    ...
    def process_robot_requests(cls):
        from dealmanagement.integration_utils.bitrix_robots.cron import process_robot_requests
